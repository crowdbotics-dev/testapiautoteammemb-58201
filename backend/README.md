...
## Project Structure
    ...
    ├── testapiautoteammemb_58201  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_58201`
...
2. Clone this repo and `cd testapiautoteammemb_58201`
